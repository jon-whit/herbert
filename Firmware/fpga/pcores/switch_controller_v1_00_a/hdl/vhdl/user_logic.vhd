...
-- Date:              Thu Feb 05 16:39:45 2015 (by Create and Import Peripheral Wizard)
...
architecture IMP of user_logic is
  ...
  ------------------------------------------
  signal switch_L_In_Signal_reg    : std_logic;
  signal switch_L_In_Stimulus_reg  : std_logic;
  signal switch_L_Out_Signal_reg   : std_logic;
  signal switch_L_Out_Stimulus_reg : std_logic;
  signal switch_F_In_Signal_reg    : std_logic;
  signal switch_F_In_Stimulus_reg  : std_logic;
  signal switch_F_Out_Signal_reg   : std_logic;
  signal switch_F_Out_Stimulus_reg : std_logic;
  signal switch_R_In_Signal_reg    : std_logic;
  signal switch_R_In_Stimulus_reg  : std_logic;
  signal switch_R_Out_Signal_reg   : std_logic;
  signal switch_R_Out_Stimulus_reg : std_logic;
  signal switch_B_In_Signal_reg    : std_logic;
  signal switch_B_In_Stimulus_reg  : std_logic;
  signal switch_B_Out_Signal_reg   : std_logic;
  signal switch_B_Out_Stimulus_reg : std_logic;
  signal switch_U_In_Signal_reg    : std_logic;
  signal switch_U_In_Stimulus_reg  : std_logic;
  signal switch_U_Out_Signal_reg   : std_logic;
  signal switch_U_Out_Stimulus_reg : std_logic;
  signal switch_D_In_Signal_reg    : std_logic;
  signal switch_D_In_Stimulus_reg  : std_logic;
  signal switch_D_Out_Signal_reg   : std_logic;
  signal switch_D_Out_Stimulus_reg : std_logic;

  signal slv_reg_write_sel     : std_logic_vector(0 to 23);
  signal slv_reg_read_sel      : std_logic_vector(0 to 23);
...
begin
  ...
  -- 
  ------------------------------------------
  slv_reg_write_sel <= Bus2IP_WrCE(0 to 23);
  slv_reg_read_sel  <= Bus2IP_RdCE(0 to 23);
  slv_write_ack     <= Bus2IP_WrCE(0) or Bus2IP_WrCE(1) or Bus2IP_WrCE(2) or Bus2IP_WrCE(3) or Bus2IP_WrCE(4) or Bus2IP_WrCE(5) or Bus2IP_WrCE(6) or Bus2IP_WrCE(7) or Bus2IP_WrCE(8) or Bus2IP_WrCE(9) or Bus2IP_WrCE(10) or Bus2IP_WrCE(11) or Bus2IP_WrCE(12) or Bus2IP_WrCE(13) or Bus2IP_WrCE(14) or Bus2IP_WrCE(15) or Bus2IP_WrCE(16) or Bus2IP_WrCE(17) or Bus2IP_WrCE(18) or Bus2IP_WrCE(19) or Bus2IP_WrCE(20) or Bus2IP_WrCE(21) or Bus2IP_WrCE(22) or Bus2IP_WrCE(23);
  slv_read_ack      <= Bus2IP_RdCE(0) or Bus2IP_RdCE(1) or Bus2IP_RdCE(2) or Bus2IP_RdCE(3) or Bus2IP_RdCE(4) or Bus2IP_RdCE(5) or Bus2IP_RdCE(6) or Bus2IP_RdCE(7) or Bus2IP_RdCE(8) or Bus2IP_RdCE(9) or Bus2IP_RdCE(10) or Bus2IP_RdCE(11) or Bus2IP_RdCE(12) or Bus2IP_RdCE(13) or Bus2IP_RdCE(14) or Bus2IP_RdCE(15) or Bus2IP_RdCE(16) or Bus2IP_RdCE(17) or Bus2IP_RdCE(18) or Bus2IP_RdCE(19) or Bus2IP_RdCE(20) or Bus2IP_RdCE(21) or Bus2IP_RdCE(22) or Bus2IP_RdCE(23);
  ...
  begin
    ...
    if Bus2IP_Clk'event and Bus2IP_Clk = '1' then
      if Bus2IP_Reset = '1' then
        switch_L_In_Stimulus_reg  <= '1';
        switch_L_Out_Stimulus_reg <= '1';
        switch_F_In_Stimulus_reg  <= '1';
        switch_F_Out_Stimulus_reg <= '1';
        switch_R_In_Stimulus_reg  <= '1';
        switch_R_Out_Stimulus_reg <= '1';
        switch_B_In_Stimulus_reg  <= '1';
        switch_B_Out_Stimulus_reg <= '1';
        switch_U_In_Stimulus_reg  <= '1';
        switch_U_Out_Stimulus_reg <= '1';
        switch_D_In_Stimulus_reg  <= '1';
        switch_D_Out_Stimulus_reg <= '1';
      else
        case slv_reg_write_sel is
          -- read-only signal
          --when "100000000000000000000000" =>
          --  for byte_index in 0 to (C_SLV_DWIDTH/8)-1 loop
          --    if ( Bus2IP_BE(byte_index) = '1' ) then
          --      slv_reg0(byte_index*8 to byte_index*8+7) <= Bus2IP_Data(31);
          --    end if;
          --  end loop;
  ...
  -- External signals
  ------------------------------------------
  switch_L_In_Stimulus  <= switch_L_In_Stimulus_reg;
  switch_L_Out_Stimulus <= switch_L_Out_Stimulus_reg;
  switch_F_In_Stimulus  <= switch_F_In_Stimulus_reg;
  switch_F_Out_Stimulus <= switch_F_Out_Stimulus_reg;
  switch_R_In_Stimulus  <= switch_R_In_Stimulus_reg;
  switch_R_Out_Stimulus <= switch_R_Out_Stimulus_reg;
  switch_B_In_Stimulus  <= switch_B_In_Stimulus_reg;
  switch_B_Out_Stimulus <= switch_B_Out_Stimulus_reg;
  switch_U_In_Stimulus  <= switch_U_In_Stimulus_reg;
