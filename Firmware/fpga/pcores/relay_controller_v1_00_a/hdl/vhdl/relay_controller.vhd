------------------------------------------------------------------------------
-- relay_controller.vhd - entity/architecture pair
------------------------------------------------------------------------------
-- IMPORTANT:
...
--
------------------------------------------------------------------------------
-- Filename:          relay_controller.vhd
-- Version:           1.00.a
-- Description:       Top level design, instantiates library components and user logic.
-- Date:              Tue Jul 29 19:05:53 2014 (by Create and Import Peripheral Wizard)
...
use relay_controller_v1_00_a.user_logic;
...
architecture IMP of relay_controller is
...
begin
  ...
  ------------------------------------------
  USER_LOGIC_I : entity relay_controller_v1_00_a.user_logic
    generic map
    (
