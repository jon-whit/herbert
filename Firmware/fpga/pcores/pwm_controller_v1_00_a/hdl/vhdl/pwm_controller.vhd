------------------------------------------------------------------------------
-- pwm_controller.vhd - entity/architecture pair
------------------------------------------------------------------------------
-- IMPORTANT:
...
use pwm_controller_v1_00_a.user_logic;
...
architecture IMP of pwm_controller is
...
begin
  ...
  ------------------------------------------
  USER_LOGIC_I : entity pwm_controller_v1_00_a.user_logic
    generic map
    (
  ...
  with ipif_Bus2IP_CS select
       ipif_IP2Bus_Data <= user_IP2Bus_Data when "10",
                           intr_IP2Bus_Data when "01",
