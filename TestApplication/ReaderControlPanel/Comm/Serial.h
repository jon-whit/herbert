...
public:
	...
	typedef enum
	{
        ...
        EHandshakeOffWithPower  =  3    // No handshaking (with DTR & RTS high for line power)
	} 
	EHandshake;
...
#ifndef SERIAL_NO_OVERLAPPED
	HANDLE	m_hReadEventOverlapped;		// Event handle for internal overlapped read operations
	HANDLE	m_hWriteEventOverlapped;	// Event handle for internal overlapped write operations
	HANDLE	m_hWaitEventOverlapped;		// Event handle for internal overlapped wait operations
#endif
