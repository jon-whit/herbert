...
void CTextProgressCtrl::OnPaint()
{
    ...
    MemDC dc(&PaintDC);						    // memory device context
	...
	if (m_bShowPercent)
    {
        ...
        tmp.Format("%d%%", (int)((dFraction * 100.0) + 0.5));
        str += tmp;
    }
	if (str.GetLength())
	{
...
////////////////////////////////////////////////////////////////////////////////
// CTextProgressCtrl extension functions

void CTextProgressCtrl::SetWindowText(const char* format, ...)
{
    CString text;
    va_list argList;
