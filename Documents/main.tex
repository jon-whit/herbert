...
ActuateArm           & 1 	     & Toggles the relay board to control the pneumatic actuations of coaxial arms.                     \\ \hline
	     
DisableMotors       & 0 	     & Default behavior of the stepper motors is to continuously draw power and hold when in a static position.  This command disables the motors.  \\ \hline
				     
TimingTest             & 0 	     & Perform an actuation and spin motion for preliminary testing to determine how fast we could perform.  \\ \hline
...
MR                         & 2 	     & Equivalent to MoveRelative just a shortened command                      \\ \hline
...
InitArms               & 0           & Spins each arm until its corresponding break sensor is made, This aligns the arms in a 90 degree position.                     \\ \hline                                                                           
\end{tabular}}
\end{table*}
